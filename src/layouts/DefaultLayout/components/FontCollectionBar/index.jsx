...
const FontCollectionBar = () => {
    ...
    return ReactDOM.createPortal(
        <div className={`fixed flex flex-col top-0 right-0 bottom-0 bg-white shadow-lg w-[340px] z-50 transition-transform ${!showCollection && "translate-x-full"}`}>
