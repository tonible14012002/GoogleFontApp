...
const Selector = ({
  ...
  return (
    <div className="relative w-fit" ref={wrapperRef} {...props}>
      <EButton
        className={`flex items-center justify-between p-2 text-sm min-w-[80px] hover:bg-slate-100 ${buttonClassName}`}
